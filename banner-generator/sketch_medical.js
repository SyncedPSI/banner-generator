...
function preload() {
  ...
  particle = {
    1: loadImage('../particles/medical/1.png'),
    2: loadImage('../particles/medical/2.png'),
    3: loadImage('../particles/medical/3.png'),
    4: loadImage('../particles/medical/4.png'),
    5: loadImage('../particles/medical/5.png'),
    6: loadImage('../particles/medical/6.png'),
    7: loadImage('../particles/medical/7.png'),
  }
}
